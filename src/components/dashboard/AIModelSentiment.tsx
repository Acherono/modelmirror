          ...
          <div className="relative w-full max-w-[180px] h-[90px] overflow-hidden mb-2">
            ...
            <div className="absolute bottom-0 left-0 w-full h-full bg-transparent">
              <div className="relative w-full h-full">
                ...
                {/* Needle */}
                <div 
                  className="absolute bottom-0 left-1/2 h-[85px] w-1 bg-white z-10 origin-bottom transform -translate-x-1/2"
                ...
                {/* Center point */}
                <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-4 h-4 bg-sidebar border-2 border-white rounded-full z-20" />
              </div>
            </div>
          </div>
